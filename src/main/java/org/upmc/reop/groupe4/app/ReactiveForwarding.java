 ...
 */
package org.upmc.reop.groupe4.app;
...
public class ReactiveForwarding {
    ...
    public void activate(ComponentContext context) {
        ...
        blackHoleExecutor = newSingleThreadExecutor(groupedThreads("groupe4",
                                                                   "black-hole-fixer",
                                                                   log));

        cfgService.registerProperties(getClass());
        appId = coreService.registerApplication("org.upmc.reop.groupe4.app");
